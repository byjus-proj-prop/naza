...
# Webdriver
browser = webdriver.Chrome("C:\\Users\\rosan\\Downloads\\chromedriver_win32 (1)\\chromedriver.exe")
...
def scrape():
    for i in range(1,6):
        ...
        for ul_tag in soup.find_all("ul", attrs={"class", "exoplanet"}):
            ...
            hiperlink = li_tags[0];
            temp_list.append("https://exoplanets.nasa.gov"+hiperlink.find_all("a", href=True)[0]["href"]);
            ## ADICIONE O CÓDIGO AQUI ##
